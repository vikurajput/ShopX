                                        ...
                                        {order.cartItems.map((item, index) => {
                                            ...
                                            return (
                                                <tr key={index} className="text-blue-300">
                                                    ...
                                                    <td onClick={()=> deleteProduct(order.id)} className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-blue-100 stroke-slate-500 text-slate-500 text-red-500 cursor-pointer ">
