    ...
    return (
        <div>
            <div className="py-5 flex justify-between items-center">
                ...
                {/* Add Product Button  */}
                <Link to={'/addproduct'}>
                <button className="px-5 py-2 bg-blue-50 border border-blue-100 rounded-lg">Add Product</button></Link>
            </div>
                ...
                <table className="w-full text-left border border-collapse sm:border-separate border-pink-100 text-blue-400" >
                    <tbody>
                        <tr>
                            ...
                            <th scope="col" className="h-12 px-6 text-md font-bold fontPara border-l first:border-l-0 border-blue-100 text-slate-700 bg-slate-100">Location Name</th>
